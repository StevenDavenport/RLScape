...
public class Constants {
    ...
    public static int WORLD = 1, HTTP_PORT = 8080, JAGGRAB_PORT = 43595, MAX_PLAYERS = 200, SAVE_TIMER = 120, TIMEOUT = 60, RESPAWN_X = 3094, RESPAWN_Y = 3106,  CYCLE_LOGGING_TICK = 10;
    public static boolean GUI_ENABLED = false, FILE_SERVER = true, SERVER_DEBUG = false, MEMBERS_ONLY = false, TUTORIAL_ISLAND = true,
            ...
            WEBSITE_INTEGRATION = false, CYCLE_LOGGING = true, RL_MODE = false;
    ...
    public static int CYCLE_TIME = 600;
    public static int RL_TICK_REPORT_EVERY = 50;
    public static String RL_TICK_REPORT_FILE = "data/rl_tick.json";
