...
public class Smithing {
	...
	public static void handleSmithingButtons(Player player, int actionButtonId) {
		// Bronze interface button handling
		if (actionButtonId == 1119) { // Bronze dagger
			Smithing smithing = new Smithing();
			smithing.readInput(player, 1, 1205, 1); // 1205 is bronze dagger item ID
		}
	}
}
