...
public class ClientSettings {
    ...
    /**
     * @RL
     * Run the client without a visible window and render offscreen.
     */
    public static boolean HEADLESS = false;

    /**
     * @RL
     * Enable the RL bridge TCP server.
     */
    public static boolean RL_BRIDGE_ENABLED = false;

    /**
     * @RL
     * Port for the RL bridge TCP server.
     */
    public static int RL_BRIDGE_PORT = 5656;
