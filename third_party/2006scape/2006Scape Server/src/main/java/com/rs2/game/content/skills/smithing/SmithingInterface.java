...
public class SmithingInterface {
	...
	public void showSmithInterface(int itemId) {
		System.out.println("DEBUG: showSmithInterface called - itemId: " + itemId + ", player: " + c.playerName + ", tutorialProgress: " + c.tutorialProgress);
		...
		if (itemId == 2349 && c.tutorialProgress == 20) {
			System.out.println("DEBUG: Opening bronze interface for tutorial progress 20");
